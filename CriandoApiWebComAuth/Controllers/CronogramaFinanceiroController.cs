...
namespace CriandoApiWebComAuth.Controllers
{
    ...
    public class CronogramaFinanceiroController : ControllerBase
    {
        ...
        public CronogramaFinanceiroController(ContabilidadeFinancas_dbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<CronogramaFinanceiro>> PostCronogramaFinanceiro(CronogramaFinanceiro cronogramaFinanceiro)
        {
          if (_context.CronogramaFinanceiros == null)
          {
              return Problem("Entity set 'ContabilidadeFinancas_dbContext.CronogramaFinanceiros'  is null.");
          }
