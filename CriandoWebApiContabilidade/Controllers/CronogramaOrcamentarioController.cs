...
namespace CriandoWebApiContabilidade.Controllers
{
    ...
    public class CronogramaOrcamentarioController : ControllerBase
    {
        ...
        public CronogramaOrcamentarioController(db_contabilidade_3tecnosContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<CronogramaOrcamentario>> PostCronogramaOrcamentario(CronogramaOrcamentario cronogramaOrcamentario)
        {
          if (_context.CronogramaOrcamentarios == null)
          {
              return Problem("Entity set 'db_contabilidade_3tecnosContext.CronogramaOrcamentarios'  is null.");
          }
